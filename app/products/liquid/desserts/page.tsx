...
const products: Product[] = [
  {
    ...
    category: "liquid",
    colors: ["Rainbow"],
    uses: ["cocktails", "beverages", "desserts"],
  },
  {
    id: "liquid-gold",
    name: "Golden Sparkle",
...
// Filter products for desserts
const dessertProducts = products.filter((product) => product.uses.includes("desserts"))
    ...
    <div className="container px-4 py-12 md:px-6 md:py-24">
      ...
      <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl elegant-text-gradient">
            Liquid Glitter for Desserts
          </h1>
          <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            Create stunning desserts with our premium organic liquid glitter
          </p>
        </div>
      </div>
      ...
      <div className="mt-16 bg-gradient-to-r from-purple-50 to-pink-50 p-8 rounded-lg">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            <h2 className="text-2xl font-bold mb-4">Pastry Chef Recommendations</h2>
            <p className="text-muted-foreground mb-4">
              Our liquid glitter products can be used in a variety of dessert applications:
            </p>
            <ul className="list-disc pl-5 text-muted-foreground space-y-2 mb-4">
              <li>Mix into clear glazes for a stunning finish on cakes and pastries</li>
              <li>Add to jellies, mousses, and panna cotta for an elegant shimmer</li>
              <li>Drizzle over plated desserts as a finishing touch</li>
              <li>Incorporate into chocolate work for a luxurious appearance</li>
            </ul>
            <Link href="/inspiration?category=desserts">
              <Button className="bg-brand-purple hover:bg-brand-lavender">View Dessert Recipes</Button>
            </Link>
          </div>
          <div className="relative h-[300px]">
            <Image
              src="/placeholder.svg?height=300&width=500"
              alt="Desserts with liquid glitter"
              fill
